...
import { ModeConfig } from "@founder-x-ai/types"
...
vi.mock("@founder-x-ai/modes", async () => {
	const actual = await vi.importActual<typeof import("@founder-x-ai/modes")>("@founder-x-ai/modes")
	return {
		...actual,
